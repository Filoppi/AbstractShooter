...
namespace UnrealMono
{
	public static class StateManager
	{
		...
		public static State CreateAndSetState(System.Type stateType)
		{
			nextState = System.Activator.CreateInstance(stateType) as State;
			prePauseState = null;
			pauseState = null;
			return nextState;
		}

		public static State CreateAndSetState(System.Type stateType, System.Type pauseStateType)
		{
			nextState = System.Activator.CreateInstance(stateType) as State;
			prePauseState = null;
			pauseState = System.Activator.CreateInstance(pauseStateType) as State;
			return nextState;
		}
		...
		public static void Update(GameTime gameTime)
		{
			if (nextState != null)
			{
				...
				//Set pauseState as currentState before doing any operations with it, as actors will be registered in global currentState
				if (pauseState != null)
				{
					prePauseState = currentState;
					currentState = pauseState;
