...
namespace AbstractShooter
{
	...
	{
		protected float movingSpeed = 83f;
		public Vector2 movingDirection = Vector2.Zero; //to protected
		...
		public ACharacterActor(Texture2D texture, List<Rectangle> frames,
			...
			: base(texture, frames, ActorUpdateGroup.Enemies, updateGroup, layerDepth, location, isLocationWorld, relativeScale, acceleration, maxSpeed, tintColor)
		{
		}
