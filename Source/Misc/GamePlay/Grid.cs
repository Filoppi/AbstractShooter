...
namespace AbstractShooter
{
	...
	public class Grid
	{
		...
		public void Draw()
		{
			...
			{
				Game1.spriteBatch.DrawLine(Camera.WorldToScreenSpace(nodesLocation[gridLine.startPoint.x, gridLine.startPoint.y]), Camera.WorldToScreenSpace(nodesLocation[gridLine.endPoint.x, gridLine.endPoint.y]), internalColor, internalColorThickness, DrawGroup.Background2);
			}
			//return;
