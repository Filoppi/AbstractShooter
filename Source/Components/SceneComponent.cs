...
namespace AbstractShooter
{
    ...
    public class CSceneComponent : CComponent
    {
        ...
        protected float localRotation; //Clockwise //Relative to partents until the root. for root components it is equal to worldRotation
            ...
            Vector2 location = new Vector2(), bool isLocationWorld = false, float relativeScale = 1F, Vector2 acceleration = new Vector2(), float maxSpeed = -1) : base(owner, updateGroup)
        {
            ...
            //To do something if this is not root and doesn't have parents???
        ...
        public bool AttachToSceneComponent(CSceneComponent parent, bool keepWorldTransform = true) //To add scale and rot
        {
                ...
                && collisionGroup > 0)
            {
                ...
                foreach (CSceneComponent foundSceneComponent in foundSceneComponents)
                {
                    if (foundSceneComponent.owner != owner
                        ...
                        && foundSceneComponent.overlappingGroups.HasFlag((ComponentCollisionGroup)collisionGroup)) //To check if root components is the same or owner?
                    {
